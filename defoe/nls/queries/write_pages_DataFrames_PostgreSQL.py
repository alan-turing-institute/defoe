""" 
Pages as string to HDFS PostgresSQL table (using dataframes), and some metadata associated with each document.
"""
...
def do_query(archives, config_file=None, logger=None, context=None):
    ...
    Data is saved as Dataframes into HDFS a PostgreSQL datatabase table
