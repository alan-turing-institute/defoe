...
def do_query(archives, config_file=None, logger=None):
    ...
    Metadata collected: Tittle, year, place, archive filename, page filename, page id, num pages, type of archive
    ...
    ('Encyclopaedia Britannica; or, A dictionary of arts, sciences, and miscellaneous literature', 
      ...
      'alto/192209952.34.xml', 'Page5', 446, 'book', u"Part III. MORAL PHILOSOPHY.....)
    ...
    pages = documents.flatMap(
        lambda year_document: [(year_document[0],year_document[1], year_document[2], year_document[3], page.code, page.page_id, year_document[4], year_document[5],   
