...
def do_query(archives, config_file=None, logger=None):
    ...
    ('Encyclopaedia Britannica; or, A dictionary of arts, sciences, and miscellaneous literature', 1810, 'Edinburgh', 
     '/mnt/lustre/at003/at003/rfilguei2/nls-data-encyclopaediaBritannica/191253839', 'alto/192209952.34.xml', 'Page5', 446, 'book', 'nls', <PreprocessWordType.NORMALIZE: 1>, 
    ...
    pages.saveAsTextFile("hdfs:///user/at003/rosa/text20.txt")
    return "0"
